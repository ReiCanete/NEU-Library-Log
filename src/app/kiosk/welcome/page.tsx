...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#0a2a1a] to-[#0d3d24]">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in duration-700 relative overflow-hidden">
          ...
          <div className="flex gap-4 w-full max-w-[500px] pt-8 border-t border-white/10 mt-4">
            <div className="bg-black/30 backdrop-blur-xl flex flex-1 items-center justify-center gap-4 p-6 rounded-[1.5rem] border border-white/5">
              ...
              <div className="text-left">
                <p className="text-[#c9a227] text-[8px] font-black uppercase tracking-widest">Date</p>
            ...
            <div className="bg-black/30 backdrop-blur-xl flex flex-1 items-center justify-center gap-4 p-6 rounded-[1.5rem] border border-white/5">
              ...
              <div className="text-left">
                <p className="text-[#c9a227] text-[8px] font-black uppercase tracking-widest">Time</p>
