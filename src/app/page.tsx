  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0a2a1a] to-[#0d3d24] flex flex-col items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="max-w-md w-full flex flex-col items-center gap-8 z-10 animate-in fade-in zoom-in duration-700">
        ...
        <Card className="bg-[#0a2a1a]/40 backdrop-blur-2xl w-full border-none ring-1 ring-[#c9a227]/30 rounded-[2.5rem] shadow-2xl">
          <CardContent className="p-8 space-y-6">
            <form onSubmit={handleIdSubmit} className="space-y-6">
              ...
              <Button className="w-full h-16 text-xl font-black rounded-2xl bg-gradient-to-r from-[#c9a227] to-[#a07d1a] text-[#0a2a1a] hover:opacity-90 shadow-2xl" disabled={loading || !studentId.trim()} type="submit">
