    ...
    return (
      <div className="h-screen bg-[#0a2a1a] flex flex-col items-center justify-center p-8 text-center text-white z-[200]">
        <div className="bg-red-500/10 p-10 rounded-[3rem] border-2 border-red-500/30 flex flex-col items-center max-w-md animate-in zoom-in duration-500">
          <ShieldX className="h-24 w-24 text-red-500 mb-6" />
          <h2 className="text-4xl font-black mb-2 uppercase tracking-tighter">Access Restricted</h2>
          <p className="text-[#c9a227] font-bold mb-6 text-sm uppercase tracking-widest">Entry denied for this ID</p>
          <div className="bg-black/30 p-6 rounded-2xl w-full text-left mb-8 border border-white/10">
            <p className="text-white/40 text-[9px] font-black uppercase tracking-widest mb-1">Reason</p>
            <p className="font-bold text-sm italic">{blockedData.reason || 'Safety/Policy Violation'}</p>
          </div>
          <p className="text-white/60 text-sm font-medium mb-10">Please contact the library administrator for assistance.</p>
          <Button 
            ...
            <CardContent className="p-8 space-y-6">
              <form onSubmit={handleIdSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  />
                  {error && (
                    <p className="text-red-400 text-[10px] font-black uppercase tracking-widest text-center mt-2 animate-in slide-in-from-top-1 duration-200">
                      {error}
                    </p>
                  )}
                </div>
              ...
              <Button 
                variant="outline" 
                className="w-full h-14 text-xs font-black border-white/10 bg-white text-[#0a2a1a] hover:bg-white/90 rounded-2xl shadow-xl transition-all flex items-center justify-center gap-3" 
                onClick={() => {
                  setLoading(true);
