...
function KioskEntryContent() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-[#0a2a1a] to-[#0d3d24] flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="max-w-md w-full flex flex-col items-center gap-8 z-10 animate-in fade-in duration-700">
        <div className="flex flex-col items-center gap-4">
          <img src="/neu-logo.png" alt="NEU Logo" width={100} height={100} className="rounded-full shadow-2xl border-2 border-[#c9a227]/30" />
