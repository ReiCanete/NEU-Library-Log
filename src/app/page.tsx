            ...
            {mode === 'kiosk' ? (
              ...
              <div className="w-full">
                <div className="flex flex-col items-center mb-6 pb-4 border-b border-white/10">
                  ...
                  <h2 className="text-white font-black tracking-[0.2em] uppercase text-[9px]">Staff Access</h2>
                  <p className="text-white/30 text-[9px] font-bold mt-1">Sign in with your NEU Google account</p>
                </div>
                <button
